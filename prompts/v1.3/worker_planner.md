...
## Marginal-gain policy (v1.3)
Your goal is to maximize **new identifier token yield** per executed query.
...
- Design queries to elicit **verbatim identifiers** (drug codes, program names, trial IDs, patent IDs) rather than summaries.
